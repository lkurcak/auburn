...
use crate::shape::{box3d::Box3d, point::Point};

impl TimeOfImpact<Collider<'_, Box3d, Vec3>> for Collider<'_, Point, Vec3> {
...
impl TimeOfImpactAndExit<Collider<'_, Box3d, Vec3>> for Collider<'_, Point, Vec3> {
...
impl TimeTravelingTimeOfImpact<Collider<'_, Box3d, Vec3>> for Collider<'_, Point, Vec3> {
...
impl TimeTravelingTimeOfImpactAndExit<Collider<'_, Box3d, Vec3>> for Collider<'_, Point, Vec3> {
...
// Reverse
impl TimeOfImpact<Collider<'_, Point, Vec3>> for Collider<'_, Box3d, Vec3> {
    fn toi(&self, other: &Collider<'_, Point, Vec3>, vel: Vec3) -> Option<f32> {
        other.toi(self, -vel)
    }
}

impl TimeOfImpactAndExit<Collider<'_, Point, Vec3>> for Collider<'_, Box3d, Vec3> {
    fn toiae(&self, other: &Collider<'_, Point, Vec3>, vel: Vec3) -> Option<(f32, f32)> {
        other.toiae(self, -vel).map(|(exit, entry)| (entry, exit))
    }
}

impl TimeTravelingTimeOfImpact<Collider<'_, Point, Vec3>> for Collider<'_, Box3d, Vec3> {
    fn tttoi(&self, other: &Collider<'_, Point, Vec3>, vel: Vec3) -> Option<f32> {
        other.tttoi(self, -vel)
    }
}

impl TimeTravelingTimeOfImpactAndExit<Collider<'_, Point, Vec3>> for Collider<'_, Box3d, Vec3> {
