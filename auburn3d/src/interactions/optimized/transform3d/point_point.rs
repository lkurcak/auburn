...
impl TimeOfImpact<Collider<'_, Point, Transform3d>> for Collider<'_, Point, Transform3d> {
...
impl TimeOfImpactAndExit<Collider<'_, Point, Transform3d>> for Collider<'_, Point, Transform3d> {
