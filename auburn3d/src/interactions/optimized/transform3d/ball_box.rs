...
impl TimeOfImpact<Collider<'_, Box3d, Transform3d>> for Collider<'_, Ball, Transform3d> {
...
impl TimeOfImpactAndExit<Collider<'_, Box3d, Transform3d>> for Collider<'_, Ball, Transform3d> {
...
// Reverse
impl TimeOfImpact<Collider<'_, Ball, Transform3d>> for Collider<'_, Box3d, Transform3d> {
    fn toi(&self, other: &Collider<'_, Ball, Transform3d>, vel: Vec3) -> Option<f32> {
        other.toi(self, -vel)
    }
}

impl TimeOfImpactAndExit<Collider<'_, Ball, Transform3d>> for Collider<'_, Box3d, Transform3d> {
