...
use crate::shape::ball::Ball;
use crate::transformation::Transform3d;

impl TimeOfImpact<Collider<'_, Ball, Transform3d>> for Collider<'_, Ball, Transform3d> {
...
impl TimeOfImpactAndExit<Collider<'_, Ball, Transform3d>> for Collider<'_, Ball, Transform3d> {
...
impl TimeTravelingTimeOfImpact<Collider<'_, Ball, Transform3d>> for Collider<'_, Ball, Transform3d> {
...
{
    fn tttoiae(&self, other: &Collider<'_, Ball, Transform3d>, vel: Vec3) -> Option<(f32, f32)> {
